<cfcomponent output="false">
	...
	<cffunction name="build" returntype="struct" output="false">
		...
		<cfset var builddir = "#expandPath('/tests/')#/../build" />
		<cfset props={"dist.dir" = "#builddir#/temp"} />
		<cf_antrunner antfile="#builddir#/build.xml" target="build.extension" properties="#props#" resultsVar="result"/>
		<cfreturn result />
	</cffunction>
